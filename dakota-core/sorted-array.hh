...
KLASS_NS sorted_array {
  FUNC   create(slots_t* slots, ssize_t capacity, ssize_t size, std_compare_t compare, boole_t is_ptr = false) -> slots_t*;
  FUNC   create(ssize_t capacity, ssize_t size, std_compare_t compare, boole_t is_ptr = false) -> slots_t*;
