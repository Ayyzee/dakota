...
#if !defined __dakota_log_hh__
#define      __dakota_log_hh__
...
import format_va_printf(2) int_t dkt_va_log(uint32_t priority, str_t format, va_list_t args);
import format_printf(   2) int_t dkt_log(   uint32_t priority, str_t format, ...);
