...
function (find_target_lib_files target-libs target-lib-files-var)
  foreach (lib ${target-libs})
    set (target-lib-file ${prefix}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}${lib}${CMAKE_SHARED_LIBRARY_SUFFIX})
...
if ("${target-type}" STREQUAL "shared-library")
  ...
  set_target_properties (${target} PROPERTIES LIBRARY_OUTPUT_DIRECTORY ${prefix}/lib)
...
elseif ("${target-type}" STREQUAL "executable")
  ...
  set_target_properties (${target} PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${prefix}/bin)
...
set (compiler-opts @${prefix}/lib/dakota/compiler.opts)
set (linker-opts   @${prefix}/lib/dakota/linker.opts)
