...
if (${target-type} STREQUAL shared-library)
  ...
  set (library-output-directory ${prefix_dir}/lib)
  ...
  set (target-output-path ${library-output-directory}/${CMAKE_SHARED_LIBRARY_PREFIX}${target}${CMAKE_SHARED_LIBRARY_SUFFIX})
elseif (${target-type} STREQUAL executable)
  add_executable (${target} ${srcs})
  set (runtime-output-directory ${prefix_dir}/bin)
