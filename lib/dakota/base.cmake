...
function (find_lib_files lib-dirs libs lib-files)
  set (lib-files)
  foreach (lib ${libs})
  ...
  endforeach ()
  set (lib-files "${lib-files}" PARENT_SCOPE)
endfunction ()

function (find_target_lib_files target-libs target-lib-files)
  ...
  endforeach ()
  set (target-lib-files "${target-lib-files}" PARENT_SCOPE)
endfunction ()
