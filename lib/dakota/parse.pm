...
my $patterns = {
  'cc_path_from_dk_path'    => '$(intmdt_dir)/%$(cc_ext) : $(source_dir)/%.dk',
  'inc_path_from_dk_path'   => '$(intmdt_dir)/%.inc      : $(source_dir)/%.dk',
  'ast_path_from_dk_path'   => '$(intmdt_dir)/%.dk.ast   : $(source_dir)/%.dk',

  'ctlg_path_from_so_path'  => '$(intmdt_dir)/%$(so_ext).ctlg : %$(so_ext)',
...
sub target_inputs_ast {
  ...
  my $target_inputs_ast_path = &target_intmdt_dir() . '/inputs.ast';
