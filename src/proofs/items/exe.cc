...
namespace int32 { typedef int32_t slots_t; object_t box(slots_t s) { return NULL; /*test hack*/ } }
using int32::box;

namespace assoc { struct slots_t { object_t key; object_t element; }; object_t box(slots_t s) { return NULL; /*test hack*/ } }
...
/**
   ...
   add terminated NULL iff its not already terminated
...
//foo(o, items => { 1, 2 });
//gets rewritten to
  foo(o, __keyword::_items, cast(object_t[]){ box(1), box(2), NULL }, NULL);
