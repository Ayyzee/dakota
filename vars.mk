...
DAKOTA-ENV-VARS += DK_ECHO_LINK_CMD=0 DK_NO_LINE=0

DAKOTA-ENV-VARS      += DK_USE_SINGLE_TARGET_HEADER=0
DAKOTA-CMD-LINE-OPTS += --define-macro DK_USE_SINGLE_TARGET_HEADER=0
