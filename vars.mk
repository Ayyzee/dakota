...
DK_TARGET_COMMON_HEADER  ?= 1
DK_INLINE_GENERIC_FUNCS  ?= 0

DAKOTA-ENV-VARS      += DK_GENERATE_TARGET_FIRST=$(DK_GENERATE_TARGET_FIRST)

DAKOTA-ENV-VARS      += DK_TARGET_COMMON_HEADER=$(DK_TARGET_COMMON_HEADER)
DAKOTA-CMD-LINE-OPTS += --define-macro DK_TARGET_COMMON_HEADER=$(DK_TARGET_COMMON_HEADER)
