...
ifdef DKT_PROFILE
  ...
  DAKOTA ?= DKT_DEPENDS_OUTPUT_FILE=$(objdir)/-depends.pl DK_NO_LINE=0 DK_NO_CONVERT_DASH_SYNTAX=0 DK_ENABLE_TRACE_MACROS=1 $(DAKOTA-BASE) --define-macro DK_ENABLE_TRACE_MACROS=1
  # --keep-going
endif
