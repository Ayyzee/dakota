...
DK_GENERATE_TARGET_FIRST    ?= 1
DK_USE_SINGLE_TARGET_HEADER ?= 1
DK_INLINE_GENERIC_FUNCS     ?= 0

DAKOTA-ENV-VARS      += DK_GENERATE_TARGET_FIRST=$(DK_GENERATE_TARGET_FIRST)
DAKOTA-CMD-LINE-OPTS += --define-macro DK_GENERATE_TARGET_FIRST=$(DK_GENERATE_TARGET_FIRST)

DAKOTA-ENV-VARS      += DK_USE_SINGLE_TARGET_HEADER=$(DK_USE_SINGLE_TARGET_HEADER)
DAKOTA-CMD-LINE-OPTS += --define-macro DK_USE_SINGLE_TARGET_HEADER=$(DK_USE_SINGLE_TARGET_HEADER)

DAKOTA-ENV-VARS      += DK_INLINE_GENERIC_FUNCS=$(DK_INLINE_GENERIC_FUNCS)
DAKOTA-CMD-LINE-OPTS += --define-macro DK_INLINE_GENERIC_FUNCS=$(DK_INLINE_GENERIC_FUNCS)
